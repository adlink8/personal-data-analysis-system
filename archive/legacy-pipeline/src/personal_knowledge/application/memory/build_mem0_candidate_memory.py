...
# -----------------------------------------------------------------------------
# Phase 07 已将 mem0 降级为可选实验，不在主路径；本模块依赖已归档的
# build_conversation_segments 输出 JSON（integration/analysis/ai_context/
# conversation_segments.json），且新管道（pk-sync conversations）不使用本模块。
