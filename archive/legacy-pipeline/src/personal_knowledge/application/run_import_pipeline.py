...
# -----------------------------------------------------------------------------
# Phase 20 迁移已删除 Agent/ GPT/ Google/ imports/ 目录，本模块引用的
# ROOT/"GPT"/"structured"/"db"/"chatgpt_data.db"、ROOT/"imports" 已不存在，
# 运行即报错。新管道（pk-sync conversations）走 ~/.agentsview/sessions.db。
