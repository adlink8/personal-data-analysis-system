...
Preferred:  python -m pipeline.build_integrated_system
"""
...
_real = import_module("personal_knowledge.application.build_integrated_system")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("personal_knowledge.application.build_integrated_system", run_name="__main__"))
