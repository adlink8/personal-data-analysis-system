...
from reconcile_knowledge_index import ReconcileReport, reconcile  # noqa: E402
...
def test_reconcile_checksum_match_passes(tmp_path: Path) -> None:
    ...
    with patch("chroma_client.ChromaClient", return_value=client):
...
def test_reconcile_missing_collection_fails(tmp_path: Path) -> None:
    ...
    with patch("chroma_client.ChromaClient", return_value=EmptyClient()):
