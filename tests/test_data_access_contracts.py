...
class DataAccessContractTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.original_db = us.UNIFIED_DB
        us.UNIFIED_DB = cls.db_path
        api_server.backend.UNIFIED_DB = cls.db_path

    @classmethod
    def tearDownClass(cls) -> None:
        us.UNIFIED_DB = cls.original_db
        api_server.backend.UNIFIED_DB = cls.original_db
        cls.tmp.cleanup()
