...
def test_delta_new_ref_creates_fresh_run(tmp_path: Path):
    ...
    from refresh_knowledge_units import prepare_delta, compute_source_checksum
...
def test_provider_model_mismatch_blocks():
    ...
    from refresh_knowledge_units import validate_provider_model
    with pytest.raises((ValueError, RuntimeError)):
...
def test_provider_no_silent_fallback():
    ...
    from refresh_knowledge_units import validate_provider_model, ProviderValidationResult
...
def test_provider_cache_key_includes_model():
    ...
    from refresh_knowledge_units import compute_cache_key
...
def test_crash_resume_same_result(tmp_path: Path):
    ...
    from refresh_knowledge_units import prepare_delta, execute_run, compute_source_checksum
    src = compute_source_checksum(canon)
...
def test_affected_subject_replacement(tmp_path: Path):
    ...
    from refresh_knowledge_units import compute_affected_subjects
...
def test_candidate_actual_id_checksum(tmp_path: Path):
    ...
    from refresh_knowledge_units import build_incremental_candidate
