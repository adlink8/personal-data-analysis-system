"""Strongly typed cross-database Personal/External decision-context binding."""
...
from personal_knowledge.external_context.service import (
    ExternalContextServiceError,
    validate_active_snapshot_policy,
)
from personal_knowledge.external_context.snapshots import ExternalSnapshotError, get_active_snapshot
