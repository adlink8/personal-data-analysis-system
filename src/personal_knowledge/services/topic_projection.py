"""Pure contract primitives for the Personal Knowledge Wiki projection.

This module deliberately has no authority, database, provider, HTTP, or index
dependencies.  It only defines the stable identifiers and the read-envelope
shape that later Wiki adapters may consume.
"""
