...
用法::
    ...
    python integration/scripts/vector/compare_vector_generations.py
    python integration/scripts/vector/compare_vector_generations.py --sample 300
"""
...
from core.project_paths import UNIFIED_DB, AI_CONTEXT_DIR, AGENT_CONVERSATIONS_DB  # noqa: E402
from core.chroma_client import ChromaClient, ChromaError  # noqa: E402
import local_embed  # noqa: E402

EVAL_DIR = _SCRIPTS_DIR.parent / "evals" / "knowledge_units"
ACTIVE_POINTER = _SCRIPTS_DIR.parent / "db" / "knowledge_index_active.txt"
