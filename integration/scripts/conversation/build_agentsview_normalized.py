...
from core.project_paths import AGENTSVIEW_DB, AGENTSVIEW_NORMALIZED_DB  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    """
    import argparse
    from source_adapters.agentsview import AgentViewAdapter, SchemaGateError
