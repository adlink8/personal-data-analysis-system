...
from core import local_embed as embed_mod
...
def write_duckdb(units: list[TurnUnit], dry: bool) -> dict:
    ...
    _ = units, dry
    raise RuntimeError(
        "DuckDB pseudo-graph path is deprecated; use \"python integration/scripts/build_conversation_graph.py --write\" instead."
    )
