...
_real = import_module("conversation.evaluate_conversation_quality")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("conversation.evaluate_conversation_quality", run_name="__main__"))
