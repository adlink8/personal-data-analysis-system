...
_real = import_module("knowledge.evaluate_knowledge_unit_extraction")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("knowledge.evaluate_knowledge_unit_extraction", run_name="__main__"))
