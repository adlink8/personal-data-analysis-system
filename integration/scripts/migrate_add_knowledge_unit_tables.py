...
_real = import_module("knowledge.migrate_add_knowledge_unit_tables")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("knowledge.migrate_add_knowledge_unit_tables", run_name="__main__"))
