...
_real = import_module("knowledge.build_knowledge_unit_vector_store")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("knowledge.build_knowledge_unit_vector_store", run_name="__main__"))
