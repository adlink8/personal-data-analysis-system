...
_real = import_module("conversation.build_conversation_segments")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("conversation.build_conversation_segments", run_name="__main__"))
