...
_real = import_module("knowledge.backfill_knowledge_unit_evidence")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("knowledge.backfill_knowledge_unit_evidence", run_name="__main__"))
