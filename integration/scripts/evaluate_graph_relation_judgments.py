...
_real = import_module("graph.evaluate_graph_relation_judgments")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("graph.evaluate_graph_relation_judgments", run_name="__main__"))
