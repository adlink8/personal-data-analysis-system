...
_real = import_module("knowledge.rollback_knowledge_checkpoint")
...
if __name__ == "__main__":
    ...
    import runpy
    raise SystemExit(runpy.run_module("knowledge.rollback_knowledge_checkpoint", run_name="__main__"))
