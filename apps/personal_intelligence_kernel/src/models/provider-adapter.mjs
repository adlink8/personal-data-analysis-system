...
export class ProviderAdapter {
  ...
  async generate({ purpose, model, prompt, task_id, session_id, event_id, idempotency_key, max_output_tokens } = {}) {
    ...
    const request = { purpose, model: route.model, prompt_ref: checksum({ prompt }), task_id, session_id, event_id: event_id ?? null, idempotency_key, max_output_tokens: max_output_tokens ?? route.max_output_tokens };
    let response;
