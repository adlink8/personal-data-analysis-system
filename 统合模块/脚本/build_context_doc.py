...
输出: 统合模块/分析数据/ai_context/person_profile.md

运行: python 统合模块\\脚本\\build_context_doc.py
"""
...
OUT_DIR = ROOT / "统合模块" / "分析数据" / "ai_context"
...
def build_markdown(stats: dict, vstats: dict) -> str:
    ...
    p("")
    p("```python")
    p("import sys; sys.path.insert(0, r'统合模块/脚本')")
