...
IN_JSON = ROOT / "统合模块" / "分析数据" / "ai_context" / "conversation_summaries.json"
OUT_JSON = ROOT / "统合模块" / "分析数据" / "ai_context" / "conversation_quality_report.json"
OUT_MD = ROOT / "统合模块" / "分析数据" / "ai_context" / "conversation_quality_report.md"
