...
输出:
  - 统合模块/分析数据/ai_context/mem0_candidate_memories.json
  - 统合模块/分析数据/ai_context/mem0_candidate_evaluation.md
"""
...
SEGMENTS_JSON = ROOT / "统合模块" / "分析数据" / "ai_context" / "conversation_segments.json"
OUT_JSON = ROOT / "统合模块" / "分析数据" / "ai_context" / "mem0_candidate_memories.json"
OUT_MD = ROOT / "统合模块" / "分析数据" / "ai_context" / "mem0_candidate_evaluation.md"
