...
运行:
  python 统合模块\脚本\visualize_conversation_graph.py
  python 统合模块\脚本\visualize_conversation_graph.py --open
"""
...
OUT_HTML = ROOT / "统合模块" / "分析数据" / "ai_context" / "conversation_graph.html"
