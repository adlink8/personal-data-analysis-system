...
from build_graph_relation_candidates import SQLITE_DB, canonical_pair
from judge_graph_relations import ALLOWED_RELATIONS

ROOT = Path(__file__).resolve().parents[2]
OUT_JSON = ROOT / "统合模块" / "分析数据" / "ai_context" / "graph_relation_eval_report.json"
OUT_MD = ROOT / "统合模块" / "分析数据" / "ai_context" / "graph_relation_eval_report.md"
