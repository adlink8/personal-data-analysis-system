...
INPUT_INDEX = INTEGRATED / "原始输入索引"
STRUCTURED = INTEGRATED / "结构化数据"
ANALYSIS = INTEGRATED / "分析数据"
DB_DIR = INTEGRATED / "SQLite数据库"
SCRIPTS = INTEGRATED / "脚本"
...
<body>
  <h1>个人系统统合分析报告</h1>
  <p>该报告由统合模块读取 Google、GPT、Agent 三个结构化数据库生成。</p>
  <div class="grid">
