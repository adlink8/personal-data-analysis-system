...
from build_graph_relation_candidates import SQLITE_DB, SUMMARIES_JSON, canonical_pair

ROOT = Path(__file__).resolve().parents[2]
PROMPT_DIR = ROOT / "统合模块" / "prompts" / "graph_relation_judge"
OUT_REPORT = ROOT / "统合模块" / "分析数据" / "ai_context" / "graph_relation_judgments_report.json"
PROMPT_VERSION = "v1"
DEFAULT_LIMIT = 5
