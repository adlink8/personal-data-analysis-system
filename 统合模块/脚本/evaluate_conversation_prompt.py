...
PROMPT_DIR = ROOT / "统合模块" / "prompts" / "conversation_compression"
EVAL_SET = ROOT / "统合模块" / "分析数据" / "ai_context" / "conversation_prompt_eval_set.json"
OUT_JSON = ROOT / "统合模块" / "分析数据" / "ai_context" / "prompt_eval_results.json"
OUT_MD = ROOT / "统合模块" / "分析数据" / "ai_context" / "prompt_eval_results.md"
...
def run(write: bool, limit: int) -> int:
    if not EVAL_SET.exists():
        ...
        print("        先运行: python 统合模块/脚本/build_conversation_eval_set.py --write")
        return 1
