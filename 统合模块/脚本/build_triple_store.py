...
import local_embed as embed_mod
...
DUCKDB_PATH = ROOT / "统合模块" / "SQLite数据库" / "conversation_graph.duckdb"
...
def load_units() -> list[TurnUnit]:
    ...
    if not SUMMARIES_JSON.exists():
        ...
        print("        先运行: python 统合模块/脚本/build_conversation_summary.py --write")
        return []
...
# 详见: 统合模块/SQLite数据库/DEPRECATED.md
