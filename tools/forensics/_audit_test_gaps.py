...
FUNCTIONAL_EXPECTATIONS = [
    {
        ...
        "modules": [
            "personal_knowledge.application.knowledge.build_knowledge_units",
            "personal_knowledge.application.knowledge.build_knowledge_units_prod",
            "personal_knowledge.evaluation.knowledge.evaluate_knowledge_unit_extraction",
            "personal_knowledge.application.knowledge.knowledge_unit_pipeline",
        ],
    ...
    },
    {
        ...
        "modules": [
            "personal_knowledge.application.knowledge.build_canonical_knowledge_units",
            "personal_knowledge.application.knowledge.build_knowledge_unit_vector_store",
            "personal_knowledge.application.knowledge.promote_knowledge_index",
            "personal_knowledge.application.knowledge.reconcile_knowledge_index",
            "personal_knowledge.application.knowledge.rollback_knowledge_checkpoint",
        ],
    ...
    },
    {
        ...
        "modules": ["personal_knowledge.application.knowledge.refresh_knowledge_units"],
    ...
    },
    {
        ...
        "modules": [
            ...
            "personal_knowledge.evaluation.knowledge.evaluate_knowledge_canary",
            "personal_knowledge.evaluation.knowledge.evaluate_knowledge_unit_rag",
        ],
    ...
    },
    {
        ...
        "modules": [
            "personal_knowledge.application.memory.build_memory_promotion_candidates",
            "personal_knowledge.application.memory.extract_memory_candidates_from_bundles",
            "personal_knowledge.application.memory.sync_memory_lifecycle",
        ],
    ...
    },
    {
        ...
        "title": "图关系候选 / 判定",
        "modules": [
            "personal_knowledge.application.graph.build_graph_relation_candidates",
            "personal_knowledge.application.graph.judge_graph_relations",
        ],
    ...
    },
    {
        ...
        "modules": [
            ...
            "personal_knowledge.application.conversation.rollback_agent_conversation_source",
