...
FUNCTIONAL_EXPECTATIONS = [
    {
        ...
        "modules": [
            "personal_knowledge.domains.knowledge.build_knowledge_units",
            "personal_knowledge.domains.knowledge.build_knowledge_units_prod",
            "personal_knowledge.domains.knowledge.evaluate_knowledge_unit_extraction",
            "personal_knowledge.domains.knowledge.knowledge_unit_pipeline",
        ],
    ...
    },
    {
        ...
        "modules": [
            "personal_knowledge.domains.knowledge.build_canonical_knowledge_units",
            "personal_knowledge.domains.knowledge.build_knowledge_unit_vector_store",
            "personal_knowledge.domains.knowledge.promote_knowledge_index",
            "personal_knowledge.domains.knowledge.reconcile_knowledge_index",
            "personal_knowledge.domains.knowledge.rollback_knowledge_checkpoint",
        ],
    ...
    },
    {
        ...
        "modules": ["personal_knowledge.domains.knowledge.refresh_knowledge_units"],
    ...
    },
    {
        ...
        "modules": [
            "personal_knowledge.retrieval.unified_search",
            "personal_knowledge.domains.knowledge.evaluate_knowledge_canary",
            "personal_knowledge.domains.knowledge.evaluate_knowledge_unit_rag",
        ],
    ...
    },
    {
        ...
        "modules": ["personal_knowledge.services.api_server", "personal_knowledge.services.mcp_server", "personal_knowledge.retrieval.unified_search"],
        "test_patterns": ["data_access", "apps_sdk", "api"],
    },
    {
        "id": "import_pipeline",
        "title": "导入管道",
        "modules": ["personal_knowledge.application.run_import_pipeline"],
    ...
    },
    {
        ...
        "modules": [
            "personal_knowledge.domains.memory.build_memory_promotion_candidates",
            "personal_knowledge.domains.memory.extract_memory_candidates_from_bundles",
            "personal_knowledge.domains.memory.sync_memory_lifecycle",
        ],
    ...
    },
    {
        ...
        "title": "图关系候选 / 判定",
        "modules": [
            "personal_knowledge.domains.graph.build_graph_relation_candidates",
            "personal_knowledge.domains.graph.judge_graph_relations",
        ],
    ...
    },
    {
        ...
        "modules": [
            "personal_knowledge.domains.conversation.build_agentsview_normalized",
            "personal_knowledge.domains.conversation.rollback_agent_conversation_source",
            "personal_knowledge.core.conversation_repository",
        ],
    ...
    },
    {
        ...
        "modules": ["personal_knowledge.application.run_pipeline"],
