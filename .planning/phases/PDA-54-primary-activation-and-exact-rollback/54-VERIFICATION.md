...
- The readiness blocker remains real: the existing pilot DB has only one independent source candidate; the second case is a duplicate admission of that candidate and is now rejected by the calibration cohort freeze guard.
